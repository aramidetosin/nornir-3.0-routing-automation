...
fig = go.Figure()
fig.add_trace(
    go.Scatter(x=df['timestamp'], y=df['utilization_in'], line=dict(color='royalblue', width=3), name='Utilization In'))
fig.add_trace(
    go.Scatter(x=df['timestamp'], y=df['utilization_out'], line=dict(color='red', width=3), name='Utilization Out'))
